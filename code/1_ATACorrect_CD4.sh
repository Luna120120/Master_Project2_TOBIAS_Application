...
PEAKS=/mnt/jw01-aruk-home01/projects/oa_functional_genomics/projects/TOBIAS/analyses/test_run/data/clean/merged_peaks/CD4_merged_peaks.bed    # Path to the BED file containing the peaks !!!
