...
#$ -N job_7_CD4_healthy                      # Job name (output .o and .e files use this name)
#$ -pe smp.pe 32
...
TOBIAS CreateNetwork --TFBS /mnt/iusers01/fatpou01/bmh01/msc-bioinf-2023-2024/f48035lh/CreateNetwork_output/CD4_healthy_bound_HSannotated_cleaned_bed/* \
    --origin /mnt/iusers01/fatpou01/bmh01/msc-bioinf-2023-2024/f48035lh/CreateNetwork_output/CD4_TFgene_geneID_final.txt
