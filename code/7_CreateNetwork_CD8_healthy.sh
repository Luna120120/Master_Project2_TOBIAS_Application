...
#$ -N job_7_CD8_healthy                      # Job name (output .o and .e files use this name)
#$ -pe smp.pe 32
...
TOBIAS CreateNetwork --TFBS /mnt/iusers01/fatpou01/bmh01/msc-bioinf-2023-2024/f48035lh/CreateNetwork_output/CD8_healthy_bound_HSannotated_cleaned_bed/* \
