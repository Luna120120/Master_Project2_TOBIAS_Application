...
HEALTHY=/mnt/jw01-aruk-home01/projects/oa_functional_genomics/projects/TOBIAS/analyses/luna_masters/data/output/ScoreBigwig_output/healthy_CD8_footprint_scores.bw
PATIENT=/mnt/jw01-aruk-home01/projects/oa_functional_genomics/projects/TOBIAS/analyses/luna_masters/data/output/ScoreBigwig_output/patient_CD8_footprint_scores.bw
...
PEAKS=/mnt/jw01-aruk-home01/projects/oa_functional_genomics/projects/TOBIAS/analyses/test_run/data/clean/merged_peaks/CD8_merged_peaks.bed
OUTDIR=/mnt/jw01-aruk-home01/projects/oa_functional_genomics/projects/TOBIAS/analyses/luna_masters/data/output/BINDetect_output/BINDetect_CD8
...
TOBIAS BINDetect --motifs $MOTIFS \
    ...
    --peaks $PEAKS \
    --outdir $OUTDIR \
    --cond_names healthy_CD8 patient_CD8 \
    --cores $NSLOTS